...
export default function RegisterTourist({ isLog }) {
        ...
        if (name === '' || msgName !== '') refs.rfName.current.focus();
            ...
            try {
                ...
                if (response.status !== 200) {
                    if (response.status === 204) alert("El correo|usuario  ya está asociado a otra cuenta");
    ...
    return (
        <div className={styles.formContainer}>
                ...
                <div className={styles.group}>
                    ...
                    <div className={styles.formGroup}>
                        ...
                        <div className={styles.containerInput}>
                            <input ref={refs.rfImag} onChange={handleImageChange} type="file" name="file-1" id="file-1" className={styles.inputfile} accept="image/*" />
                            <label htmlFor="file-1">
                                ...
                                <span className={styles.iborrainputfile} style={{ color: "#fff" }}>{image ? image.name : "Seleccionar archivo"}</span>
                            </label>
                        </div>
                    </div>
                    <div className={styles.formGroup}>
            ...
            <div className={styles.formSubmit}>
                {isLog && (
                    <button className={styles.buttonSubmit} onClick={handleClickSubmit}>Registrar Turista</button>
                )}
            </div>
        </div>
    );
